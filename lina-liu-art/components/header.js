    ...
    return (
        <>
            <div className={`${className} flex flex-row sm:flex-col sm:justify-between sm:w-1/4 sm:h-screen p-1 text-gray-800 sm:pl-4 sm:text-xl sm:fixed`}>
              <div className='flex justify-between sm:flex-col w-full'>       
                <div className='p-3 sm:w-40 sm:h-56 odd:bg-red-600 rounded-lg cursor-pointer'>
                    <Link href='/'>
                ...
                query={query}
                setQuery={setQuery}/>
                <div className='flex flex-col content-start content-around justify-evenly w-1/2 sm:w-full my-0 my-4 pl-1'>
